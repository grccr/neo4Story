...
/***/ function(module, exports, __webpack_require__) {
	...
	var configValidator = __webpack_require__(42); /**
	                                                      * Created by forwardmomentum on 21.02.17.
	                                                      */

	describe('configValidation', function () {
	    it('validateNodeTypesConfig1', function () {
	        var nodeTypesSample = [];
	    ...
	    it('validateNodeTypesConfig2', function () {
	        var nodeTypesSample = [{
	            name: 'Test'
	        }];
	        var validationResult = configValidator.validateNodeTypes(nodeTypesSample);
	    ...
	    it('validateNodeTypesConfig3', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test'
	        }];
	    ...
	    it('validateNodeTypesConfig4', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: []
	    ...
	    it('validateNodeTypesConfig5', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig6', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig7', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig8', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig9', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig10 - valid config', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig11 - editControl in types', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig12 - conSearchFields in fields', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig13 - swSearchFields in fields', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig14 - swSearchField empty', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig15 - conSearchField empty', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateNodeTypesConfig15 - con/swSearchFields are both empty', function () {
	        var nodeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            fields: [{
	    ...
	    it('validateEdgeTypesConfig1', function () {
	        ...
	        var nodeTypesSample = [{ name: 'Test' }, { name: 'Debug' }];
	        var validationResult = configValidator.validateEdgeTypes(edgeTypesSample, nodeTypesSample);
	        (0, _chai.expect)(validationResult.success).to.be.false;
	    });
	    ...
	    it('validateEdgeTypesConfig3', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test'
	        }];
	    ...
	    it('validateEdgeTypesConfig4', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true
	    ...
	    it('validateEdgeTypesConfig5', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig6', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig7', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig8', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig9', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig10', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig11', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig12', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
	    ...
	    it('validateEdgeTypesConfig13 - valid config', function () {
	        var edgeTypesSample = [{
	            name: 'Test',
	            value: 'test',
	            oriented: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    validateNodeTypes: function validateNodeTypes(nodeTypes) {
	        ...
	        var _loop = function _loop(typeIndex) {
	            var type = nodeTypes[typeIndex];
	            if (!type.name) return {
	                    v: { success: false, message: 'type with ' + typeIndex + ' has no name!' }
	                };
	            if (!type.value) return {
	                    v: { success: false, message: 'type with ' + type.name + ' has no value!' }
	                };
	            if (!type.fields) return {
	                    v: { success: false, message: 'type ' + type.name + ' has no fields!' }
	                };
	            ...
	            if (type.fields.filter(function (field) {
	                return !field.name;
	                    ...
	                    v: { success: false, message: 'type ' + type.name + ' has field/s without name!' }
	                };

	            if (type.fields.filter(function (field) {
	                return !field.alias;
	            }).length > 0) return {
	                    v: { success: false, message: 'type ' + type.name + ' has field/s without alias!' }
	                };
	            ...
	            var fieldNames = type.fields.map(function (field) {
	                return field.name;
	            });

	            if (!fieldNames.includes(type.mainLabelField)) return {
	                    v: { success: false, message: 'type ' + type.name + ' has mainLabelField not from fields of this type!' }
	                };
	            ...
	            if (type.fields.filter(function (field) {
	                ...
	                return !validEditControls.includes(field.editControl);
	                    ...
	                    v: { success: false, message: 'type ' + type.name + ' has field with not valid editControl!' }
	                };

	            if (!type.swSearchFields) return {
	                    v: { success: false, message: 'type ' + type.name + ' has no swSearchFields' }
	                };

	            flag = true;

	            if (type.swSearchFields) {
	                type.swSearchFields.forEach(function (searchField) {
	                    if (!fieldNames.includes(searchField)) flag = false;
	                });
	            }
	            if (!flag) return {
	                    v: { success: false, message: 'type ' + type.name + ' has swSearchField/s not from fields of this type!' }
	                };

	            if (!type.conSearchFields) return {
	                    v: { success: false, message: 'type ' + type.name + ' has no conSearchFields' }
	                };

	            if (type.conSearchFields.length == 0 && type.swSearchFields.length == 0) return {
	                    v: { success: false, message: 'type ' + type.name + ' has both swSearchField conSearchFields empty' }
	                };

	            flag = true;
	            if (type.conSearchFields) {
	                type.conSearchFields.forEach(function (searchField) {
	                    if (!fieldNames.includes(searchField)) flag = false;
	                });
	            }
	            if (!flag) return {
	                    v: { success: false, message: 'type ' + type.name + ' has conSearchField/s not from fields of this type!' }
	                };
	        ...
	        for (var typeIndex in nodeTypes) {
	            ...
	            var _ret = _loop(typeIndex);

	            if ((typeof _ret === 'undefined' ? 'undefined' : (0, _typeof3.default)(_ret)) === "object") return _ret.v;
	        }
	        return { success: true };
	    },
	    validateEdgeTypes: function validateEdgeTypes(edgeTypes, nodeTypes) {

	        if (!nodeTypes) return { success: false, message: 'node types undefined!' };
	        if (!edgeTypes) return { success: false, message: 'node types undefined!' };
	        var nodeTypesNames = nodeTypes.map(function (type) {
	            return type.name;
	        });
	        ...
	        for (var typeIndex in edgeTypes) {
	            ...
	            if (!_type.hasOwnProperty('oriented')) return { success: false, message: 'type ' + _type.name + ' has no orientation!' };
	            ...
	            if (!_type.allowedLinks) return { success: false, message: 'type ' + _type.name + ' has no allowedLinks!' };

	            if ((0, _keys2.default)(_type.allowedLinks).length === 0 && _type.allowedLinks.constructor === Object) return { success: false, message: 'type ' + _type.name + ' has empty allowedLinks!' };

	            if (_type.allowedLinks) {
	                for (var key in _type.allowedLinks) {
	                    if (_type.allowedLinks.hasOwnProperty(key)) {
	                        // do stuff
	                        if (!nodeTypesNames.includes(key)) {
	                            return {
	                                success: false,
	                                message: 'type ' + _type.name + ' has non existing ' + 'nodeTypeName: ' + key + ' as a key in allowedLinks' };
	                        }
	                        if (!_type.allowedLinks[key]) return {
	                            success: false,
	                            message: ' allowedLinks with key ' + key + '' + 'of type ' + _type.name + ' has no allowedLinks!'
	                        };
	                        if (_type.allowedLinks[key] == 0) return {
	                            success: false,
	                            message: ' allowedLinks with key ' + key + '' + 'of type ' + _type.name + ' has empty allowedLinks!'
	                        };
	                        var flag = true;
	                        if (_type.allowedLinks[key]) {
	                            _type.allowedLinks[key].forEach(function (secondNode) {
	                                if (!nodeTypesNames.includes(secondNode)) flag = false;
	                            });
	                            if (!flag) return {
	                                success: false,
	                                message: 'type ' + _type.name + ' has non existing node type under the key ' + key
	                            };
	                        }
	                    }
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(68)(IteratorPrototype, __webpack_require__(92)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var configPreparer = __webpack_require__(116); /**
	                                                    * Created by forwardmomentum on 21.02.17.
	                                                    */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = __webpack_require__(118).mutations; /**
	...
	var actions = __webpack_require__(118).actions;

	// destructure assign mutations
	var ADD_NODE_TO_SELECTION = mutations.ADD_NODE_TO_SELECTION,
	    ADD_EDGE_TO_SELECTION = mutations.ADD_EDGE_TO_SELECTION;
	var addNodeToSelection = actions.addNodeToSelection,
	    addEdgeToSelection = actions.addEdgeToSelection;


	describe('mutations', function () {
	    it('ADD_NODE_TO_SELECTION', function () {
	        // mock state
	        var state = {
	            nodes: [{
	                id: 'test'
	    ...
	    it('ADD_EDGE_TO_SELECTION', function () {
	        // mock state
	        var state = {
	            nodes: [],
	            edges: [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(121);
	...
	module.exports = {
	    ...
	    mutations: {
	        ADD_NODE: function ADD_NODE(state, payload) {
	        ...
	        RESET_SELECTION: function RESET_SELECTION(state) {
	            var tempNodes = [];
	            var tempEdges = [];
	            state.nodes.forEach(function (node) {
	                node.selected = false;
	        ...
	        SET_GRAPH: function SET_GRAPH(state, graph) {
	        ...
	        UPDATE_GRAPH: function UPDATE_GRAPH(state, graph) {
	            // console.log(graph);
	            // console.log('IN MUTATION!!!');
	            var tempNodes = state.nodes;
	            var tempEdges = state.edges;
	            var tempNodesMap = state.nodesMap;
	            var tempEdgesMap = state.edgesMap;
	            graph.nodes.forEach(function (node) {
	                if (node.id in state.nodesMap) {} else {
	                    node.selected = false;
	                    tempNodes.push(node);
	            ...
	            graph.edges.forEach(function (edge) {
	                if (edge.id in state.edgesMap) {} else {
	                    tempEdges.push(edge);
	        ...
	        GRAPH_LAYOUT: function GRAPH_LAYOUT(state, layoutFlag) {
	    ...
	    actions: {
	        ...
	        //
	        // }),
	        deactivateSelect: function deactivateSelect(store, payload) {
	            // can be replaced with selectNodes([]). if correct -> delete
	            store.commit("SELECT_ELEMENTS", false);
	        },
	        updateGraph: function updateGraph(store, graph) {
	            store.commit("SET_GRAPH", graph);
	            // store.commit("SET_NODES", graph.nodes);
	        },
	        addSubGraphBySearchRequest: function addSubGraphBySearchRequest(store, payload) {
	            if (payload.searchRequest && payload.searchRequest.length > 0) {
	                store.dispatch('neo4jFindAllMatches', payload).then(function (graphResponse) {
	                    store.commit('UPDATE_GRAPH', graphResponse);
	                });
	            }
	        },
	        addSubGraphById: function addSubGraphById(store, payload) {
	            store.dispatch('neo4jSearchById', payload).then(function (graphResponse) {
	                store.commit('UPDATE_GRAPH', graphResponse);
	            });
	        },
	        addNewEdge: function addNewEdge(store, payload) {
	            store.dispatch('neo4jCreateEdge', payload).then(function (graph) {
	        ...
	        addNewNode: function addNewNode(store, payload) {
	            // if (payload.nodeType == 'Person') {
	            store.dispatch('neo4jCreateNode', payload).then(function (graph) {
	                return store.commit("UPDATE_GRAPH", graph);
	            });
	            // }
	        ...
	        addNodeToSelection: function addNodeToSelection(store, element) {
	            store.commit("ADD_NODE_TO_SELECTION", element);
	        },
	        addEdgeToSelection: function addEdgeToSelection(store, element) {
	            store.commit("ADD_EDGE_TO_SELECTION", element);
	        },
	        resetSelection: function resetSelection(store) {
	            store.commit("RESET_SELECTION");
	        },
	        exploreNode: function exploreNode(store, payload) {
	            store.dispatch("neo4jSearch", payload);
	        },
	        cleanGraph: function cleanGraph(store, graph) {
	            store.commit("SET_GRAPH", { nodes: [], edges: [], nodesMap: {}, edgesMap: {} });
	        },
	        graphLayout: function graphLayout(store, payload) {
