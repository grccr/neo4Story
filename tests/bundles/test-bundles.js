	...
	module.exports = {
	    validateNodeTypes: function validateNodeTypes(nodeTypes) {
	        ...
	        for (var typeIndex in nodeTypes) {
	            ...
	            if (type.fields.filter(function (field) {
	                return !field.name;
	            }).length > 0) return { success: false, message: 'type ' + type.name + ' has field/s without name!' };
	            if (type.fields.filter(function (field) {
	                return !field.alias;
	            }).length > 0) return { success: false, message: 'type ' + type.name + ' has field/s without alias!' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var configPreparer = __webpack_require__(44); /**
	                                                    * Created by forwardmomentum on 21.02.17.
	                                                    */
